...
function addDetails(){
    ...
    if(inpDate.value == '' || inpDesc.value == '' || inpDebit.value == '' || inpTotal.value == '' || inpRemarks.value == ''){
        alert("Please fill all the fields!")
        return
    }
    // var tr = document.createElement("tr")
    ...
    detailsObj['remaining'] = inpTotal.value - inpDebit.value
...
function delBusiness(e){
    firebase.database().ref("Users").on("child_added",function(data){
        ...
        if("business"+data.id == e.parentNode.parentNode.id){
            var business = e.parentNode.parentNode.id
...
function update(){
    ...
    firebase.database().ref("Users").on("child_added",function(data){
        ...
        if("business"+data.id == updtId && data.name == businessname.value ){
            usersObj['date'] = data.date
            usersObj['name'] = businessname.value
